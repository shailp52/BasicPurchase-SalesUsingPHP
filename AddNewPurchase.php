 ...
 ?> 
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="Execute/ExPurchasing.php" method="post" class="form-horizontal" id="product-validate" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Quantity In Store</label>
                                            <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="SupplierPhone" name="SupplierPhone" class="form-control" data-mask="(999) 999-9999"/>
