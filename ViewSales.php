        ...
        <div id="content">
            ...
            <div class="inner">
				...
				if($role=="Manager")
				{
					...
					//$idd=$_SESSION["CName"];       
					$query= $dbo->query("SELECT * FROM  sales ORDER by salesid DESC");
                                           ...
                                           <td>
                                            <?php 
												$IDProduct=$product['IDProduct'];
                                           		 $quer= mysqli_query($link, "SELECT DISTINCT product_name FROM product where productid='$IDProduct'");
				...
				else
				{
					...
					//$idd=$_SESSION["CName"];       
					$query= $dbo->query("SELECT * FROM  sales WHERE IDBranch='$IDBranch' ORDER by salesid DESC");
					foreach ($query as $product) {
                                        ...
                                        <tr class="odd gradeX">
                                           ...
                                           <td>
                                            <?php 
												$IDProduct=$product['IDProduct'];
                                           		 $quer= mysqli_query($link, "SELECT DISTINCT product_name FROM product where productid='$IDProduct'");
												 while($i = mysqli_fetch_array($link, $quer))
														{
													$product_name=$i['product_name'];
													}
											?>
