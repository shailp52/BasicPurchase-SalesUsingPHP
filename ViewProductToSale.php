                ...
                <div class="col-lg-12">
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <?php 
												$IDProduct=$product['productid'];
                                           		 $quer= mysqli_query($link, "SELECT DISTINCT Price FROM price where IDProduct='$IDProduct'");
												 while($i = mysqli_fetch_array($quer))
													{
														$Price=$i['Price'];
													}
											?>
											<?php if(!isset($Price)) echo 'No Selling Price';
												else echo $Price;?>
                                            
                                            </td>
											<td class="center"><?php echo $product['measure'];?></td>
											<td class="center"><?php echo $product['status'];?></td>
                                            <td class="center">
                                            <a href="AddNewSales.php? id=<?php echo $product['productid'];?>">
                                            <button class="btn"><i class=" icon-shopping-cart"></i> Cart</button> </a>
                                            </td>
                                        </tr>
                                    <?php } }
					...
					?>
                                        <tr class="odd gradeX">
											...
											?>
											<?php 
												 if(!isset($Price)) echo 'No Selling Price';
												else echo $Price;
											?>
