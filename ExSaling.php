...
//	}
 ...
 {
$query ="INSERT INTO sales (`IDProduct`, `Price`, `QuatityInStore`, `QuantitySold`, `TotalPrice`, `AmountPaid`, `Balance`, `ClientName`, `PhoneNumber`, `SaleDate`, `IDInvoice`, `IDUSer`, `IDBranch`) VALUES ('$IDProduct','$Price','$QuatityInStore','$Quantity2','$TotalPrice2','$AmountPaid','$Balance','$ClientName','$ClientPhone','$date2','$InvoiceNumber','$IDUSer')"; 
