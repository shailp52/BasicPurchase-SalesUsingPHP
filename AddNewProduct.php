                            ...
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="Execute/ExAddProduct.php" method="post" class="form-horizontal" id="product-validate" enctype="multipart/form-data" >
										...
										<div class="form-group">
                                            <label class="control-label col-lg-4">Measure</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4"> Purchasing Price(in INR/unit)</label>
										...
										<div class="col-lg-8">
										 ...
										 <div class="form-group">
                                            <label class="control-label col-lg-4" id="Status">Status</label>
                                            <div class="col-lg-4">
