...
<body class="padTop53 ">
 ...
 <?php
      ...
      $queri= $dbo->query("SELECT * FROM price where IDProduct='$idd'");
      foreach ($queri as $price) {
 ...
 ?> 
                                ...
                                <span class="input-group-addon add-on" data-toggle="modal" data-target="#NewInvoiceNumber"><i class=" icon-plus"></i></span>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4"> Price (per Unit)</label>
                                            <div class="col-lg-4 ">
											<?php
												if (isset($Price)) 	{
													$style = 'readonly value='.$Price.'';
												}
												
											?>
                                              <input type="number" id="Price" name="Price" class="form-control" <?php echo $style ?> />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="ClientPhone" name="ClientPhone" class="form-control" data-mask="(999) 999-9999"/>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
