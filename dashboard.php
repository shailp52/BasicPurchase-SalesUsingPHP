    ...
    <div id="wrap" >
        ...
        <div id="top">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <header class="navbar-header">
                    ...
                    <img src="assets/img/logo.png" alt="" height=50px width=120px/>
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <?php } ?>
                <li><a href="Execute/ExDestroySession.php"><i class="icon-signin"></i> Logout </a></li>
                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?PHP
                            ...
                            <a class="quick-btn" href="ViewProduct.php">
