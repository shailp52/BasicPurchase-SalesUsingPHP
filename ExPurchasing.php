...
$quer= mysqli_query($link, "SELECT DISTINCT quantity FROM product where productid='$IDProduct'");
while($i = mysqli_fetch_array($quer))
	{
	$QuatityInStore=$i['quantity'];
	}
	
$query ="INSERT INTO purchase (`IDProduct`, `Quantity`, `Price`, `TotalPrice`, `SupplierName`, `SupplierPhone`, `Date`, `IDUser`) 
